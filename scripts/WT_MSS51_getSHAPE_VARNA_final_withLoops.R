rm(list =ls())
wkdir <- "/Users/ahramahn/Dropbox/Mac/Documents/dreem_seq/Yeast-trans_act/COX1/new_results/"
setwd(wkdir) ; getwd() ; dir()

library(dplyr)

# List of file names
file_names <- c("WT_COX1_5UTR", "WT_COX1_CDS", "WT_COX1_3UTR", 
                "MSS51_COX1_5UTR", "MSS51_COX1_CDS", "MSS51_COX1_3UTR")

# Loop over the file names
for (file in file_names) {
  # Construct the file path
  file_path <- paste(file, "ratio_average.csv", sep="_")
...
WT_COX1_5UTR_processed <- process_sample(WT_COX1_5UTR)
WT_COX1_3UTR_processed <- process_sample(WT_COX1_3UTR)
WT_COX1_CDS_processed <- process_sample(WT_COX1_CDS)

MSS51_COX1_5UTR_processed <- process_sample(MSS51_COX1_5UTR)
MSS51_COX1_3UTR_processed <- process_sample(MSS51_COX1_3UTR)
MSS51_COX1_CDS_processed <- process_sample(MSS51_COX1_CDS)
get("MSS51_COX1_CDS_processed")

# List of processed data frame names
processed_names <- c("WT_COX1_5UTR_processed", "WT_COX1_CDS_processed", "WT_COX1_3UTR_processed", 
                     "MSS51_COX1_5UTR_processed", "MSS51_COX1_CDS_processed", "MSS51_COX1_3UTR_processed")
...
WT_COX1_5UTR_processed_varna <- process_sample(WT_COX1_5UTR)
WT_COX1_3UTR_processed_varna <- process_sample(WT_COX1_3UTR)
WT_COX1_CDS_processed_varna <- process_sample(WT_COX1_CDS)

MSS51_COX1_5UTR_processed_varna <- process_sample(MSS51_COX1_5UTR)
MSS51_COX1_3UTR_processed_varna <- process_sample(MSS51_COX1_3UTR)
MSS51_COX1_CDS_processed_varna <- process_sample(MSS51_COX1_CDS)


processed_names2 <- c("WT_COX1_5UTR_processed_varna", "WT_COX1_CDS_processed_varna", "WT_COX1_3UTR_processed_varna", 
                     "MSS51_COX1_5UTR_processed_varna", "MSS51_COX1_CDS_processed_varna", "MSS51_COX1_3UTR_processed_varna")
...
all_processed_names <- c("WT_COX1_5UTR_processed", "WT_COX1_CDS_processed", "WT_COX1_3UTR_processed", 
                         "MSS51_COX1_5UTR_processed", "MSS51_COX1_CDS_processed", "MSS51_COX1_3UTR_processed",
                         "WT_COX1_5UTR_processed_varna", "WT_COX1_CDS_processed_varna", "WT_COX1_3UTR_processed_varna", 
                         "MSS51_COX1_5UTR_processed_varna", "MSS51_COX1_CDS_processed_varna", "MSS51_COX1_3UTR_processed_varna")
