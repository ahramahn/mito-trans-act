rm(list =ls())
wkdir <- "/Users/ahramahn/OneDrive - University of Miami/1. Research/DMS-MaP-Seq/Yeast-trans_act/COX1/new_results/MSS116"
setwd(wkdir) ; getwd() ; dir()

library(dplyr)

# List of file names
file_names <- c("MSS116_COX1_5UTR", "MSS116_COX1_CDS", "MSS116_COX1_3UTR")
...
MSS116_COX1_5UTR_processed <- process_sample(MSS116_COX1_5UTR)
MSS116_COX1_3UTR_processed <- process_sample(MSS116_COX1_3UTR)
MSS116_COX1_CDS_processed <- process_sample(MSS116_COX1_CDS)



# List of processed data frame names
processed_names <- c("MSS116_COX1_5UTR_processed", "MSS116_COX1_CDS_processed", "MSS116_COX1_3UTR_processed")
...
MSS116_COX1_5UTR_processed_varna <- process_sample(MSS116_COX1_5UTR)
MSS116_COX1_3UTR_processed_varna <- process_sample(MSS116_COX1_3UTR)
MSS116_COX1_CDS_processed_varna <- process_sample(MSS116_COX1_CDS)



processed_names2 <- c("MSS116_COX1_5UTR_processed_varna", "MSS116_COX1_CDS_processed_varna", "MSS116_COX1_3UTR_processed_varna")
...
all_processed_names <- c("MSS116_COX1_5UTR_processed", "MSS116_COX1_CDS_processed", "MSS116_COX1_3UTR_processed", 
                         "MSS116_COX1_5UTR_processed_varna", "MSS116_COX1_CDS_processed_varna", "MSS116_COX1_3UTR_processed_varna")
